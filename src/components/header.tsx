...
export default function Header() {
    ...
    // Prevent scroll waktu menu terbuka
    useEffect(() => {
        if (isOpen) {
    ...
    return (
        <>
            <header className="bg-secondary/30 backdrop-blur-sm flex items-center w-full ring-1 ring-secondary py-4 px-6 sticky top-0 z-50">
                <nav className="flex flex-row items-center justify-between w-full max-w-350 mx-auto">
                    {/* Logo */}
                    <div className="flex items-center gap-10">
                        <Link
                            // href="https://evocave.com"
                            href="/"
                            aria-label="Go to Evocave homepage"
                        >
                            <svg
                                width="126"
                                height="32"
            ...
            {isOpen && (
                <div
                    className="lg:hidden fixed inset-0 top-14.25 z-40 bg-background/95 backdrop-blur-sm"
